...
const VerifyNotice = () => {
  ...
  <div className="verify-notice">
    <div className="verify-notice__container">
      <main>
        <section>
          ...
          <div className="content">
            ...
            <p>We've sent a link to your email to verify your account. This is to prevent others from signing up with your info. Please check your mail and click the link.</p>
            <p>Didn't receive the email? <span onClick={resendVerification} className="resend-verification">Click to Resend link</span></p>
